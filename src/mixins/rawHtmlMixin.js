  ...
  methods: {
    styleRawHTML(rawHTML, linkColor = 'comebackkc-darkblue') {
      return rawHTML
        ...
        .replace(/<h1.*?>/g, '<h1 class="text-6xl mb-4">')
        .replace(/<h2.*?>/g, '<h2 class="text-5xl mb-4">')
        .replace(/<h3.*?>/g, '<h3 class="text-4xl mb-4">')
        .replace(/<h4.*?>/g, '<h4 class="text-3xl mb-4">')
        .replace(/<h5.*?>/g, '<h5 class="text-2xl mb-4">')
        .replace(/<h6.*?>/g, '<h6 class="text-xl mb-4">')
